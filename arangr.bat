@echo off
title Arangr Application - Complete Manager
...
echo.
echo ================================================
echo         Arangr Application Manager
echo ================================================
echo.
...
echo.
echo >> Starting Arangr Application...
echo.
python main.py
...
python -c "from ui.main_window import ArangrExplorer" >nul 2>&1
if %ERRORLEVEL% NEQ 0 (
...
if "%DEPS_OK%"=="1" (
    ...
    echo.
    echo Your Arangr Application is ready to run.
...
python -c "from ui.main_window import ArangrExplorer; print('Main application: OK')" 2>nul || echo "Main application: FAILED"
...
:EXIT
echo.
echo Thank you for using Arangr Application!
echo.
exit /b 0
